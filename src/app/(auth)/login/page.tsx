      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <div className="space-y-2">
            <h2 className="text-xl text-foreground">Preparazione Esami Orali con AI</h2>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Unisciti a migliaia di studenti. Registra le domande dei tuoi esami e accedi a risposte intelligenti.
            </p>
          </div>
        </div>
