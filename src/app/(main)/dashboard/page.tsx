...
export default async function DashboardPage() {
  ...
  const statItems = [
    { label: "Domande Aggiunte", value: stats.questionsAdded, icon: Plus },
    { label: "Domande Studiate", value: stats.questionsStudied, icon: Eye },
    { label: "Domande Salvate", value: stats.questionsSaved, icon: Star },
    { label: "Attività", value: stats.streak, icon: Calendar },
  ];
        ...
        <Card className="border-green-200 bg-green-50 dark:bg-green-950/20">
          <CardContent className="pt-6">
            ...
            <p className="text-sm text-green-600 dark:text-green-500">
              Ora puoi usare l&apos;IA per ottenere spiegazioni dettagliate di qualsiasi risposta.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-orange-200 bg-orange-50 dark:bg-orange-950/20">
          <CardContent className="pt-6">
            <p className="font-medium text-orange-700 dark:text-orange-400 mb-1">
              🎓 Periodo d&apos;Esami in arrivo
            </p>
            <p className="text-sm text-orange-600 dark:text-orange-500">
              Mantieni il tuo ritmo di studio!{" "}
              {stats.streak > 0
                ? `Hai studiato per ${stats.streak} giorni consecutivi.`
          ...
          {recentQuestions.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground mb-4">
                Non hai ancora interagito con nessuna domanda
              </p>
              <Link href="/search">
                <Button>
